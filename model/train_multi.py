...
data_dir = work_dir + 'data/experiment4/'
log_dir = work_dir + 'log/experiment4/'
...
def train(X_df, y_df, random_seed, ratio):
    ...
    [train_set, val_set, test_set], [X_train_id, X_eval_id, X_test_id], le = encode(X_df, y_df, cdr_char, test_size, pad_len, le=True, col_names={'id':'Id','sequence':seq})
...
def main():
    ...
    y_df = pd.read_csv(f'{data_dir}HA-ANARCI_y.csv')['binding'] # print(y_df.value_counts())
