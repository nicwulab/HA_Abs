...
def CDR_model_original6(mlp_units,n_classes,rate=0.1,max_length=30, multi_class=False):
    input1=Input(shape=(30,))
    input2=Input(shape=(30,))
    input3=Input(shape=(30,))
    input4=Input(shape=(30,))
    input5=Input(shape=(30,))
    ...
    encoder4=build_t_encoder(num_layers=4,d_model=256,num_heads=4,dff=512,input_vocab_size=22,maximum_position_encoding=max_length)(input4)
    encoder5=build_t_encoder(num_layers=4,d_model=256,num_heads=4,dff=512,input_vocab_size=22,maximum_position_encoding=max_length)(input5)
    encoder6=build_t_encoder(num_layers=4,d_model=256,num_heads=4,dff=512,input_vocab_size=22,maximum_position_encoding=max_length)(input6)
